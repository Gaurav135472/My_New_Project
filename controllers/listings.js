...
//          console.log( "req body ", req.body); // Log the body to see the structure
...
module.exports.updateListing = async (req, res) => {
    ...
    console.log(req.file);
    const { id } = req.params;
    const updatedData = req.body.listing; // Ensure this matches your schema

    let listing = await Listing.findByIdAndUpdate(id, updatedData, { new: true }); // Fetch updated document with new data
